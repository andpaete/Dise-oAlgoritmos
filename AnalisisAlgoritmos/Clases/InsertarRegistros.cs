...
namespace AnalisisAlgoritmos.Clases
{
    ...
    {
        public static void insertarRegistros(int id_algoritmo,int id_rango, double tiempo_cpu,double tiempo_total_eje,double tiempo_e_s,double porcentaje_cpu_wall)
        {
            try
            {
                ...
                c.AddLista("@tiempo_total_eje", tiempo_total_eje);
